# Documentacao Do UniNFe

Este indice organiza a documentacao Markdown do UniNFe. As paginas devem ser criadas de forma incremental, sempre com base em evidencias encontradas no repositorio.

## Introducao

- [Introducao](introducao/)
- [O que é o UniNFe](introducao/o-que-e-uninfe.md)
- PENDENTE DE VALIDAÇÃO: criar `introducao/visao-geral-de-funcionamento.md`
- PENDENTE DE VALIDAÇÃO: criar `introducao/conceitos-importantes.md`

## Instalacao

- [Instalacao](instalacao/)
- [Instalação do UniNFe](instalacao/instalacao.md)
- PENDENTE DE VALIDAÇÃO: criar `instalacao/primeira-execucao.md`
- [Atualização do UniNFe](instalacao/atualizacao.md)
...
- PENDENTE DE VALIDAÇÃO: criar `configuracao/webservices-e-ambientes.md`
- PENDENTE DE VALIDAÇÃO: criar `configuracao/pastas-de-trabalho.md`

## Integracao Por Arquivos

- [Integracao](integracao/)
- PENDENTE DE VALIDAÇÃO: criar `integracao/visao-geral-integracao-por-arquivos.md`
- PENDENTE DE VALIDAÇÃO: criar `integracao/envio-de-arquivos.md`
- PENDENTE DE VALIDAÇÃO: criar `integracao/leitura-de-retornos.md`
- PENDENTE DE VALIDAÇÃO: criar `integracao/nomes-de-arquivos.md`
...
- [CTe](servicos/cte/)
- [CTe - Autorização síncrona](servicos/cte/autorizacao-sincrona.md)
- [CTe - Autorização de CTe simplificado](servicos/cte/autorizacao-cte-simplificado.md)
- [CTe - Autorização de CTe OS](servicos/cte/autorizacao-cte-os.md)
- [CTe - Consulta de situação](servicos/cte/consulta-situacao.md)
- [CTe - Consulta status de serviço](servicos/cte/consulta-status-servico.md)
...
- [MDFe - Consulta status de serviço](servicos/mdfe/consulta-status-servico.md)
- [MDFe - Eventos](servicos/mdfe/eventos.md)
- [NF-e ABI](servicos/nfeabi/)
- [NF-e ABI - Autorização síncrona](servicos/nfeabi/autorizacao-sincrona.md)
- [NF-e ABI - Consulta status de serviço](servicos/nfeabi/consulta-status-servico.md)
- [NFCom](servicos/nfcom/)
- [NFCom - Autorização síncrona](servicos/nfcom/autorizacao-sincrona.md)
- [NFCom - Consulta de situação](servicos/nfcom/consulta-situacao.md)
- [NFCom - Consulta status de serviço](servicos/nfcom/consulta-status-servico.md)
- [NFCom - Eventos](servicos/nfcom/eventos.md)
- [NFGas](servicos/nfgas/)
- [NFGas - Autorização síncrona](servicos/nfgas/autorizacao-sincrona.md)
- [NFGas - Consulta de situação](servicos/nfgas/consulta-situacao.md)
- [NFGas - Consulta status de serviço](servicos/nfgas/consulta-status-servico.md)
- [NFGas - Eventos](servicos/nfgas/eventos.md)
- [NF3e](servicos/nf3e/)
- [NF3e - Autorização síncrona](servicos/nf3e/autorizacao-sincrona.md)
- [NF3e - Consulta de situação](servicos/nf3e/consulta-situacao.md)
- [NF3e - Consulta status de serviço](servicos/nf3e/consulta-status-servico.md)
- [NF3e - Eventos](servicos/nf3e/eventos.md)
- [BPe](servicos/bpe/)
- [BPe - Autorização síncrona](servicos/bpe/autorizacao-sincrona.md)
- [BPe - Autorização síncrona de BPe TA](servicos/bpe/autorizacao-sincrona-bpe-ta.md)
- [BPe - Autorização síncrona de BPe TM](servicos/bpe/autorizacao-sincrona-bpe-tm.md)
...
- [CIOT - Consultar frota do transportador](servicos/ciot/consultar-frota-transportador.md)
- [CIOT - Consultar situação do transportador](servicos/ciot/consultar-situacao-transportador.md)
...
- [eBoleto - Consultar boleto](servicos/eboleto/consultar-boleto.md)
...
- [Catalogo da documentacao](_catalogo-documentacao.md)
