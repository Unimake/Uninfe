# UniNFe - NF-e ABI - Brief NF-e ABI
...
- Estado observado: projeto existente, sem docsplan/nfeabi/planning anterior; árvore Git limpa na inspeção de 2026-09-10.
- Não objetivos: modernização de stack, refatoração ampla, endpoint de produção inventado, deploy, commit ou push.

## Cobertura

Produto, destino, arquitetura, integrações, segurança, qualidade, ambientes, evolução, governança, PDCA, riscos e entrega estão definidos para revisão do DEV. Dados persistidos próprios, banco, identidade, UI nova, acessibilidade e localização são N/A porque o incremento é biblioteca/fluxo fiscal XML dentro de produto existente; a exposição de NF-e ABI ocorrerá somente nos seletores e fluxos de configuração existentes, seguindo NFGas e sem tela nova.
