# Hashes da fonte normativa — UAB-002

- Data da conferência: 2026-09-15.
- Método: leitura integral dos dois MOCs, parsing XML integral dos vinte XSDs e reprodução do agregado segundo a regra aprovada.
...
| Conjunto | Arquivos | Referência | Plan | Resultado |
|---|---:|---|---|---|
...
O Check deve reproduzir os dois valores antes da entrega.
