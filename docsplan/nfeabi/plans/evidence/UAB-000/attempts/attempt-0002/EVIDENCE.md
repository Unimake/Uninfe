...
Os sete caminhos exclusivos do pacote foram movidos de `docs/` para `docsplan/nfeabi/`. Referências operacionais, manifests, orquestradores, dossiê e linter agora apontam para `docsplan/nfeabi/`. O conteúdo preexistente de `docs/` permaneceu no lugar.
