...
> **Decisões necessárias:** DEC-002 e DEC-007
> **Manifesto:** docsplan/nfeabi/plans/manifests/UAB-004.json
...
Task/status NFeABI, roteamento mínimo, testes e exemplo sintético. O dossiê, o PDCA e as evidências desta etapa ficam restritos a `docsplan/nfeabi/`.

## 7. Contratos, invariantes e arquitetura

- Reutilizar o contrato ERP compartilhado de Status: `-ped-sta.xml`, `-sta.xml` e `-sta.err`.
- Rotear a NFeABI pelo elemento raiz `consStatServNFeABI`, sem introduzir novo sufixo.
...
|---:|---|---|---:|---|---|
| 1 | build NFe.Service + testes focados de status/contexto | ENV-UNI-DEBUG | 15 min | retorno/erro/cleanup corretos sem secret | docsplan/nfeabi/plans/evidence/UAB-004/evidence/validation.txt |
...
- Pasta: docsplan/nfeabi/plans/evidence/UAB-004/.
