...
> **Manifesto:** docsplan/nfeabi/plans/manifests/UAB-000.json
...
`docs/`, `.agents/` e seção DevPlanner do README/AGENTS. O dossiê, o PDCA e as evidências desta etapa ficam restritos a `docsplan/nfeabi/`.
...
|---:|---|---|---:|---|---|
| 1 | `pwsh -NoProfile -File .agents/skills/plan-linter/scripts/test-plan.ps1 -RepositoryRoot .` | ENV-PLAN | 15 min | linter retorna 0 | docsplan/nfeabi/plans/evidence/UAB-000/evidence/validation.txt |
...
- Pasta: docsplan/nfeabi/plans/evidence/UAB-000/.
