...
> **Manifesto:** docsplan/nfeabi/plans/manifests/UAB-006.json
...
Correções NFABI estritas, testes, exemplos e documentação/indexes. O dossiê, o PDCA e as evidências desta etapa ficam restritos a `docsplan/nfeabi/`.
...
|---:|---|---|---:|---|---|
| 1 | `dotnet build source/uninfe.sln -c Debug --no-restore` quando ambiente permitir + UniNFe.Test Debug focado + testes DLL NFeABI Debug | ENV-INTEGRATED | 15 min | gates determinísticos verdes e docs/index consistentes | docsplan/nfeabi/plans/evidence/UAB-006/evidence/validation.txt |
...
- Pasta: docsplan/nfeabi/plans/evidence/UAB-006/.
