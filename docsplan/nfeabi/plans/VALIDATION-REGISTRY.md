...
| UAB-006 | `dotnet build source/uninfe.sln -c Debug --no-restore` quando ambiente permitir + UniNFe.Test Debug focado + testes DLL NFeABI Debug | ENV-INTEGRATED | gates determinísticos verdes e docs/index consistentes |
