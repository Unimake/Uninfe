...
#define MyAppVersion "2026.06.18.1041"
...
AppId={{2D3EF4D3-10CF-4225-9669-2993963D6CEF}
AppName={#MyAppName}
...
AllowUNCPath=False
VersionInfoVersion=2026.06.18.1041
VersionInfoCopyright=2020 - Todos os direitos reservados
VersionInfoProductName=Unimake.DFe
VersionInfoProductVersion=2026.06.18.1041
VersionInfoProductTextVersion=2026.06.18.1041
...
;----------------------------------------------------------------------------------------------------
Source: "C:\projetos\github\Unimake.DFe\Exemplos\VB6\System.Security.Cryptography.Xml.dll"; DestDir: "{app}"; Flags: ignoreversion
;----------------------------------------------------------------------------------------------------
;Registrar
;----------------------------------------------------------------------------------------------------
...
;----------------------------------------------------------------------------------------------------
;Gerador de CIOT em produção e dependências
;----------------------------------------------------------------------------------------------------
