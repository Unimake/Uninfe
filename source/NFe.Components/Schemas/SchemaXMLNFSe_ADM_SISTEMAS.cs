...
namespace NFSe.Components
{
    public class SchemaXMLNFSe_ADM_SISTEMAS
    {
        public static void CriarListaIDXML()
        {
            ...
            #region XMl de Consulta de NFSe de Serivço Prestado

            SchemaXML.InfSchemas.Add("NFSE-ADM_SISTEMAS-ConsultarNfseServicoPrestadoEnvio", new InfSchema()
            {
                Tag = "ConsultarNfseServicoPrestadoEnvio",
                ID = SchemaXML.InfSchemas.Count + 1,
                ArquivoXSD = "NFSe\\ADM_SISTEMAS\\nfse v2 01.xsd",
                Descricao = "XML de Consulta de NFSe de Serviço Prestado",
                TagAssinatura = "",
                TagAtributoId = "",
                TargetNameSpace = "http://www.abrasf.org.br/nfse.xsd"
            });

            #endregion XMl de Consulta de NFSe de Serivço Prestado

            #region XMl de Consulta de NFSe de Serivço Tomado

            SchemaXML.InfSchemas.Add("NFSE-ADM_SISTEMAS-ConsultarNfseServicoTomadoEnvio", new InfSchema()
            {
            ...
            #endregion XMl de Consulta de NFSe de Serivço Tomado
        }
    }
}