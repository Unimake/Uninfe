    ...
    public class SchemaXMLNFSe_SIMPLISS
    {
        public static void CriarListaIDXML()
        {
            ...
            */
            ...
            #endregion Versão 3.00

            #region Versão 2.03

            #region XML de Cancelamento de NFS-e

            SchemaXML.InfSchemas.Add("NFSE-SIMPLISS-2.03-CancelarNfseEnvio", new InfSchema()
            {
                Tag = "CancelarNfseEnvio",
                ID = SchemaXML.InfSchemas.Count + 1,
                ArquivoXSD = "",
            ...
            SchemaXML.InfSchemas.Add("NFSE-SIMPLISS-2.03-GerarNfseEnvio", new InfSchema()
            {
                Tag = "GerarNfseEnvio",
                ID = SchemaXML.InfSchemas.Count + 1,
                ArquivoXSD = "",
            ...
            SchemaXML.InfSchemas.Add("NFSE-SIMPLISS-2.03-ConsultarNfseRpsEnvio", new InfSchema()
            {
            ...
            #region XML de lote RPS
            SchemaXML.InfSchemas.Add("NFSE-SIMPLISS-2.03-EnviarLoteRpsEnvio", new InfSchema()
            {
                Tag = "EnviarLoteRpsEnvio",
                ID = SchemaXML.InfSchemas.Count + 1,
                ArquivoXSD = "",
            ...
            #region XML de Substituir NFSe
            SchemaXML.InfSchemas.Add("NFSE-SIMPLISS-2.03-SubstituirNfseEnvio", new InfSchema()
            {
