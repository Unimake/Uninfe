...
namespace NFSe.Components
{
    public class SchemaXMLNFSe_SUPERNOVA
    {
        public static void CriarListaIDXML()
        {
            ...
            SchemaXML.InfSchemas.Add("NFSE-SUPERNOVA-SubstituirNfseEnvio", new InfSchema()
            {
                Tag = "SubstituirNfse",
                ID = SchemaXML.InfSchemas.Count + 1,
                ArquivoXSD = "NFSe\\SUPERNOVA\\nfse.xsd",
                Descricao = "XML Para substituir a nota antiga",
                TagAssinatura = "Pedido",
                TagAtributoId = "InfPedidoCancelamento",
            ...
            SchemaXML.InfSchemas.Add("NFSE-SUPERNOVA-GerarNfseEnvio", new InfSchema()
            {
                Tag = "GerarNfse",
                ID = SchemaXML.InfSchemas.Count + 1,
                ArquivoXSD = "NFSe\\SUPERNOVA\\nfse.xsd",
                Descricao = "XML Para Gerar Nota Fiscal de Serviço",
                TagAssinatura = "Rps",
                TagAtributoId = "InfDeclaracaoPrestacaoServico",
                TargetNameSpace = "http://www.abrasf.org.br/nfse.xsd"
            });
