...
=> Path.GetExtension(NomeArquivoXML).ToLower() == ".xml";
        ...
        protected string NomeClasseCabecWS(int cUF, Servicos servico) => NomeClasseCabecWS(cUF, servico, (int)TipoEmissao.Normal);
        ...
        protected string NomeClasseCabecWS(int cUF, Servicos servico, int tpEmis)
        {
            ...
            switch (servico)
            {
                ...
                case Servicos.CTeRecepcaoEvento:
                    ...
                    if (cUF == 50 &&
                        (tpEmis == (int)TipoEmissao.Normal || tpEmis == (int)TipoEmissao.ContingenciaEPEC || tpEmis == (int)TipoEmissao.ContingenciaFSDA)
        ...
        protected string NomeMetodoWS(Servicos servico, int cUF) => NomeMetodoWS(servico, cUF, "");
        ...
        {
            var retorna = string.Empty;
            var cUFeVersao = cUF.ToString().Trim() + "|" + versao;
        ...
        {
            var gerarXML = new GerarXML(empresa);
