    ...
    public class TaskConsultarNfsePDF: TaskAbst
    {
        ...
        public override void Execute()
        {
            ...
            try
            {
                ...
                var padraoNFSe = Functions.BuscaPadraoNFSe(oDadosPedNfsePDF.cMunicipio);
        ...
        public void ConvertBase64ToPDF(int emp, PadraoNFSe padraoNFSe)
        {
        ...
        /// 
        private void ExtrairPDF(int emp, Unimake.Business.DFe.Servicos.NFSe.ConsultarNfsePDF consultarNfsePDF, PadraoNFSe padraoNFSe)
        {
