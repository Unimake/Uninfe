    ...
    public class TaskBoletoInformarPagto : TaskAbst
    {
        ...
        private void ExecuteDLL(int emp)
        {
            ...
            try
            {
                ...
                var boletoType = assembly.GetType("Unimake.Business.DFe.Servicos.EBoleto.BoletoInformarPagto");
                if (boletoType == null) throw new Exception("A implementação do serviço eBoleto BoletoInformarPagto não foi localizada na DLL.");
                ...
                if (executarMethod == null) throw new Exception("A implementação do serviço eBoleto BoletoInformarPagto não expõe o método Executar().");
