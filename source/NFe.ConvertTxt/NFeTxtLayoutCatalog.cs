    ...
    internal static class NFeTxtLayoutCatalog
    {
        internal static Dictionary<string, string> Criar()
        {
            const string prefix = "§";
                    ...
                    layouts.Add("UB17_8", prefix + "UB17|pIBSUF|pDif|vDif|vDevTrib|pRedAliq|pAliqEfet|vIBSUF|"); //Layout anterior
                    layouts.Add("UB36", prefix + "UB36|pIBSMun|pDif|vDif|pDevTrib|vDevTrib|pRedAliq|pAliqEfet|vIBSMun|"); //IBSCBS->gIBSCBS->gIBSMun
                    layouts.Add("UB36_8", prefix + "UB36|pIBSMun|pDif|vDif|vDevTrib|pRedAliq|pAliqEfet|vIBSMun|"); //Layout anterior
                    layouts.Add("UB55", prefix + "UB55|pCBS|pDif|vDif|pDevTrib|vDevTrib|pRedAliq|pAliqEfet|vCBS|"); //IBSCBS->gIBSCBS->gCBS
                    layouts.Add("UB55_8", prefix + "UB55|pCBS|pDif|vDif|vDevTrib|pRedAliq|pAliqEfet|vCBS|"); //Layout anterior
