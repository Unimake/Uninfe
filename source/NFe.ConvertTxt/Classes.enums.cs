...
namespace NFe.ConvertTxt
{
    ...
    public enum TpcnIndicadorBemMovelUsado
    {
        iBemMovelUsado = 1
    }
    public enum TpcnCRT
    ...
    public enum TpcnTipoEnteGovernamental
    {
    ...
    public enum TpcnTipoOperacaoEnteGovernamental
    {
