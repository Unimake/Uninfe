...
namespace NFe.UI
{
    ...
    public static class uninfeDummy
    {
        ...
        public static IList DatasouceTipoAplicativo(bool soConsulta)
        {
            ...
            list.Add(new KeyValuePair<int, string>((int)TipoAplicativo.SATeMFE, EnumHelper.GetDescription(TipoAplicativo.SATeMFE)));
            ...
            if (!soConsulta)
            {
                ...
                list.Add(new KeyValuePair<int, string>((int)TipoAplicativo.GNREeDARE, EnumHelper.GetDescription(TipoAplicativo.GNREeDARE)));   
            }
