...
namespace NFe.UI.Formularios
{
    ...
    public partial class userConfiguracao_certificado : MetroFramework.Controls.MetroUserControl
    {
        ...
        /// <summary>
        /// Verifica se o CNPJ ou CPF do certificado digital é igual ao documento da empresa configurada.
        /// </summary>
        ...
        private void button_selecionar_certificado_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    var oCertDig = new Unimake.Security.Platform.CertificadoDigital();

                    oMeuCert = oCertDig.AbrirTelaSelecao();
