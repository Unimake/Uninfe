...
namespace NFe.UI.Formularios
{
    public partial class FormNova : MetroFramework.Forms.MetroForm
    {
        ...
        private void metroButton1_Click(object sender, EventArgs e)
        {
            ...
            {
                cnpj = Functions.OnlyNumbers(edtCNPJ.Text, ".-/").ToString() + Functions.OnlyNumbers(txtbInscricaoEstadual.Text.Trim(), ".-/").ToString();      //Adicionei o campo da Inscrição estadual para permitir mais de uma por CPF
            }
            else
            {
        ...
        {
            if (comboDocumento.SelectedIndex.Equals(0))
            {
                txtbInscricaoEstadual.Enabled = true;
                txtbInscricaoEstadual.Visible = true;
                lbInscricaoEstadual.Visible = true;
            }
            else
            {
                txtbInscricaoEstadual.Enabled = false;
                txtbInscricaoEstadual.Visible = false;
