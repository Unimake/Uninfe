    ...
    public class Empresa
    {
        ...
        public string PastaBase
        {
            get
            {
                ...
                {
                    throw new Exception("Falha na definição da pasta base da empresa " + Nome + " do CNPJ " + CNPJ + "\r\n\r\nConfira a definição das pastas de envio, retorno, etc, pois tem algo de errado.");
                }
        ...
        private string _PastaXmlEnvio;
        private string _PastaXmlRetorno;
        private string _PastaXmlEnviado;
        private string _PastaXmlErro;
        private string _PastaBackup;
        private string _PastaXmlEmLote;
        private string _PastaValidar;
        private string _PastaDanfeMon;
        private string _PastaDownloadNFeDest;
        private string _PastaExeUniDanfe;
        private string _PastaConfigUniDanfe;

        /// <summary>
        /// Pasta onde deve ser gravado os XML´s a serem enviados
        /// </summary>
        public string PastaXmlEnvio
        {
            get => _PastaXmlEnvio;
            set => _PastaXmlEnvio = CorrigePasta(value);
        }

        /// <summary>
        /// Pasta onde será gravado os XML´s de retorno para o ERP
        /// </summary>
        public string PastaXmlRetorno
        {
            get => _PastaXmlRetorno;
            set => _PastaXmlRetorno = CorrigePasta(value);
        }

        /// <summary>
        /// Pasta onde será gravado os XML´s enviados
        /// </summary>
        public string PastaXmlEnviado
        {
            get => _PastaXmlEnviado;
            set => _PastaXmlEnviado = CorrigePasta(value);
        }

        /// <summary>
        /// Pasta onde será gravado os XML´s que apresentaram algum tipo de erro em sua estrutura
        /// </summary>
        public string PastaXmlErro
        {
            get => _PastaXmlErro;
            set => _PastaXmlErro = CorrigePasta(value);
        }
        ...
        {
            get => _PastaBackup;
            set => _PastaBackup = CorrigePasta(value);
        }
        ...
        public string PastaXmlEmLote
        {
            get => _PastaXmlEmLote;
            set => _PastaXmlEmLote = CorrigePasta(value);
        }

        /// <summary>
        /// Pasta onde é gravado os XML´s da NFE somente para validação
        /// </summary>
        public string PastaValidar
        {
            get => _PastaValidar;
            set => _PastaValidar = CorrigePasta(value);
        }
        ...
        /// </summary>
        [NFe.Components.AttributeTipoAplicacao(TipoAplicativo.Nfe)]
        public string PastaDanfeMon
        {
            get => _PastaDanfeMon;
            set => _PastaDanfeMon = CorrigePasta(value);
        }
        /// <summary>
        /// Pasta para onde será gravado os XML´s de download das NFe de destinatarios
        /// </summary>
        [NFe.Components.AttributeTipoAplicacao(TipoAplicativo.Nfe)]
        public string PastaDownloadNFeDest
        {
            get => _PastaDownloadNFeDest;
            set => _PastaDownloadNFeDest = CorrigePasta(value);
        }

        public string PastaContingencia => CorrigePasta(Path.Combine(PastaXmlEnvio, "Contingencia"));

        public string PastaValidado => CorrigePasta(Path.Combine(PastaValidar, "Validado"));
        ...
        /// <summary>
        /// Intervalo de tempo (em segundos) entre o envio de cada arquivo de NFSe
        /// </summary>
        public int TempoEnvioNFSe { get; set; }
        /// <summary>
        /// Data e hora que a última NFSe foi enviada
        /// </summary>
        ...
        /// <summary>
        /// Alterna entre os serviços de RecepcionarLoteRps(Síncrono/Assíncrono) para municípios de padrão THEMA.
        /// </summary>
        public bool RpsSincAssincTHEMA { get; set; }

        /// <summary>
        /// Habilita ou desabilita a gravação de avisos na pasta retorno
        /// </summary>
        public bool GravarWarnings { get; set; }
        ...
        /// </summary>
        [NFe.Components.AttributeTipoAplicacao(TipoAplicativo.Nfe)]
        public string PastaExeUniDanfe
        {
            get => _PastaExeUniDanfe;
            set => _PastaExeUniDanfe = CorrigePasta(value);
        }
        ...
        /// </summary>
        [NFe.Components.AttributeTipoAplicacao(TipoAplicativo.Nfe)]
        public string PastaConfigUniDanfe
        {
            get => _PastaConfigUniDanfe;
            set => _PastaConfigUniDanfe = CorrigePasta(value);
        }
        ...
        /// uMessenger AppID
        /// </summary>
        public string AppID_UMessenger { get; set; }

        /// <summary>
        /// uMessenger Secret
        /// </summary>
        public string Secret_UMessenger { get; set; }

        /// <summary>
        /// uMessenger - Enviar os erros do UniNfe
        /// </summary>
        public bool ErrosUniNFe { get; set; }

        /// <summary>
        /// uMessenger - Utilizar os mesmos dados (Ebank e uMessenger)
        /// </summary>
        public bool MesmosDadosEb_Mb { get; set; }

        /// <summary>
        /// uMessenger - Avisar documentos denegados
        /// </summary>
        public bool DocumentosDenegados { get; set; }

        /// <summary>
        /// uMessenger - Avisar documentos rejeitados
        /// </summary>
        public bool DocumentosRejeitados { get; set; }

        /// <summary>
        /// uMessenger - Numero WhatsApp
        /// </summary>
        public string NumeroUMessenger { get; set; }


        #endregion Propriedades EBank uMessenger
        ...
        public string BuscaConfiguracao(ref int tipoerro)
        {
            ...
            if (File.Exists(NomeArquivoConfig))
            {
                try
                {
                    ...
                    var temp = File.ReadAllText(NomeArquivoConfig, Encoding.UTF8);
                    ...
                    t.Secret = Criptografia.descriptografaSenha(t.Secret);
        ...
        public X509Certificate2 BuscaConfiguracaoCertificado()
        {
            ...
            if (UsaCertificado)
            {
                ...
                else //Certificado está sendo acessado direto do arquivo .PFX
                {
                    ...
                    using (var fs = new FileStream(CertificadoArquivo, FileMode.Open, FileAccess.Read))
                    {
        ...
        /// <summary>
        /// Corrige falha de barras das pastas configuradas
        /// Por algum motivo, em algum sistema operacional, pode ser o ERP que esteja passando errado
        /// está ficando, nas pastas, com a barra caída para a direita e não a invertida, temos que corrigir para
        /// evitar erros.
        /// </summary>
        /// <param name="pasta">Pasta</param>
        /// <returns>Conteúdo da pasta já corrigida</returns>
        private string CorrigePasta(string pasta)
        {
            var retorna = pasta;

            if (pasta.Contains("/"))
            {
                retorna = pasta.Replace("/", "\\");
            }
        ...
        {
            var file = string.Format("{0}\\{1}-{2}.lock", PastaBase, Propriedade.NomeAplicacao, Environment.MachineName);
        ...
        {
            PastaXmlEnvio = ConfiguracaoApp.FixAbsolutePath(PastaXmlEnvio);
            ...
            PastaDanfeMon = Servico == TipoAplicativo.Nfse ? "" : ConfiguracaoApp.FixAbsolutePath(PastaDanfeMon);
            PastaExeUniDanfe = Servico == TipoAplicativo.Nfse ? "" : ConfiguracaoApp.FixAbsolutePath(PastaExeUniDanfe);
            PastaConfigUniDanfe = Servico == TipoAplicativo.Nfse ? "" : ConfiguracaoApp.FixAbsolutePath(PastaConfigUniDanfe);
        }

        #region SalvarConfiguracao()
        public void SalvarConfiguracao(bool validaCertificado, bool validarConfig)
        {
            var empresaNova = false;
            try
            {
                ...
                {
                    var emp = Empresas.FindConfEmpresaIndex(CNPJ, Servico);
                    this.CopyObjectTo(Empresas.Configuracoes[emp]);
                }

                //Se não tiver a pasta do executável do Unidanfe, significa que não usa a parte de emissão do UNIDANFE.
                if (string.IsNullOrWhiteSpace(PastaExeUniDanfe))
                {
                    PastaConfigUniDanfe = string.Empty;
                }
               ...
               if (!Directory.Exists(PastaEmpresa))
                ...
                dados.AppID = Criptografia.criptografaSenha(dados.AppID);
        ...
        public void SendFileToFTP(string fileName, string folderName)
        {
            ...
            if (File.Exists(fileName) && FTPIsAlive)
            {
                ...
                {
                    var arqDestino = Path.Combine(Path.GetTempPath(), Path.GetFileName(fileName));
                    //Copia o arquivo para a pasta temp
                    var oArquivo = new FileInfo(fileName);
                    oArquivo.CopyTo(arqDestino, true);

                    var ftp = new FTP(FTPNomeDoServidor, FTPPorta, FTPNomeDoUsuario, FTPSenha);
                    try
                    {
                        //conecta ao ftp
                        ftp.Connect();
                        ...
                        var vCorrente = ftp.GetWorkingDirectory();
                        ...
                        var remote_filename = folderName + "/" + Path.GetFileName(fileName);
        ...
        /// <param name="fileName"></param>
        /// <param name="folderName"></param>
        public void SendToFTP(string fileName, string folderName)
        {
            //verifique se o arquivo existe e se o FTP da empresa está configurado e ativo
            if (File.Exists(fileName) && FTPIsAlive)
            {
        ...
        public void SalvarConfiguracoesNFSeSoftplan(string usuario, string senha, string clientID, string clientSecret, string cnpj, DateTime? tokenValidade, string token)
        {
            try
            {
                ...
                var declaration = xmlConfiguracao.CreateXmlDeclaration("1.0", "UTF-8", "");
                xmlConfiguracao.AppendChild(declaration);

                var configuracao = xmlConfiguracao.CreateElement("Configuracao");
                xmlConfiguracao.AppendChild(configuracao);

                var usuarioConfiguracao = xmlConfiguracao.CreateNode(XmlNodeType.Element, "Usuario", "");
                var senhaConfiguracao = xmlConfiguracao.CreateNode(XmlNodeType.Element, "Senha", "");
                var clientIDConfiguracao = xmlConfiguracao.CreateNode(XmlNodeType.Element, "ClientID", "");
                var clientSecretConfiguracao = xmlConfiguracao.CreateNode(XmlNodeType.Element, "ClientSecret", "");
                var tokenConfiguracao = xmlConfiguracao.CreateNode(XmlNodeType.Element, "TokenNFSe", "");
                var tokenExpireConfiguracao = xmlConfiguracao.CreateNode(XmlNodeType.Element, "TokenNFSeExpire", "");
                ...
                if (tokenValidade.HasValue)
                {
                    tokenExpireConfiguracao.InnerText = tokenValidade.Value.ToString();
        ...
        public Empresa RecuperarConfiguracaoNFSeSoftplan(string cnpj)
        {
            ...
            try
            {
                ...
                if (File.Exists($@"{Path.Combine(Path.GetDirectoryName(Application.ExecutablePath), cnpj, "ConfiguracaoNFSeSoftplan.xml")}"))
                {
                    ...
                    if (xmlConfiguracao.GetElementsByTagName("TokenNFSeExpire")[0] != null)
                    {
                        DateTime tokenExpire;
                        if (DateTime.TryParse(xmlConfiguracao.GetElementsByTagName("TokenNFSeExpire")[0].InnerText, out tokenExpire))
                        {
                            result.TokenNFSeExpire = tokenExpire;
                        }
                    }
                }
            }
